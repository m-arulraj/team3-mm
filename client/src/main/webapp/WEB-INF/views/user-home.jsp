			...
			<div class="agile_info">
				...
				<div class="w3_info" align="center">
					...
					<div class="bs-example" align="center">
						&emsp;<a href='/investmentResource'><button type="button" class="btn btn-primary btn-lg btn-block"><i class="fab fa-stack-exchange" style="font-size:25px"></i> INVESTMENT</button></a>
						&emsp;<a href='/incomeResource'><button type="button" class="btn btn-primary btn-lg btn-block"><i class="fas fa-wallet" style="font-size:25px"></i> INCOME</button></a>
						&emsp;<a href='/expenseResource'><button type="button" class="btn btn-primary btn-lg btn-block"><i class="fab fa-amazon-pay" style="font-size:25px"></i> EXPENSE</button></a>
						&emsp;<a href='/user-reports'><button type="button" class="btn btn-primary btn-lg btn-block"> <span class="glyphicon glyphicon-stats" style="font-size:25px"></span> REPORTS</button></a>
						&emsp;<a href='/user-transaction/all-transactions'><button type="button" class="btn btn-primary btn-lg btn-block"><i class="fa fa-history" style="font-size:25px"></i> TRANSACTIONS</button></a>
