...
<main class="flw page_content service-detail" id=main>
    <nav class="flw breadcrumb">
        <div class=container>
            <div class="flw bread">
                <h3 class=page-title>How to plan for a trip</h3>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="flw case-detail-right">
                    <div class=case-detail-info>
                        <h3 class=case-detail-info-name>HOW TO PLAN FOR A TRIP</h3>
                    </div>
                    		<p class="case-detail-content">
					Planning a long trip can be a intimidating task. Where do you begin? What’s step one? What’s step two? What’s step three? It’s easy to get overwhelmed in the beginning, especially when you haven’t done something like this before.<br><br>
 ...
 <div class="project-tabs flw">
			<div id="tabs1" class="project-tabs-content display-none">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						<!-- <h3>THE Problem</h3> -->
						<p>When Planning for a trip the main factors that impact are where to go, how many people are actually going for the trip and what would be the total budget for the trip. </p>
					</div>
				</div>
			...
			<div id="tabs2" class="project-tabs-content display-none">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						<h4>1  Decide Where You Want To Go</h4> <br><br>

						<p>Lot of people talk vaguely about travel. They never say where they are going, just that they are going. Picking a destination is immensely important, as it gives you a definite goal. </p><br><br>
						<h4> 2  Research Your Costs</h4>
						 <br>
							<p> So you know where you’re going and how long you’ll be there, but to really know how much money you need, your next task is to research the costs in your destination and the style of travel you want. <br><br>

						</p>
						<h4>3  Start Saving Money</h4><br>
							<p>Time to start saving! Write down all your current expenses so you can determine where you are spending money and how you can cut back.All of that adds up and creating this breakdown can let you know where you need to cut and save.
						</p><br><br>
						<h4>4  Book Your Accommodation</h4><br>
							<p>If you have a set schedule, feel free to book accommodation for the duration of your trip, but if you are going to be traveling long-term, book just the first few days. Once you know the dates you’ll be in your destination, there is no real reason not to find a place to stay.
						</p>
						<h4>5  Plan Your Activities</h4>
						<p>Sketch out the major activities you want to enjoy and how much they cost. Make any last-minute adjustments to your savings so you can ensure you have enough money. This will also help you figure out if you need any reservations for your chosen tours or activities.</p>
					</div>
				</div>
				<div class="col-md-7 col-lg-7">
					<img alt="img" src="https://www.expensebit.com/assets/upload/chart-61b56e21a02323dd9f296e51f325dd8220e8323b0e7f6e96df89744e4c1b7ceb.png" />
