...
<main class="flw page_content service-detail" id=main>
    <nav class="flw breadcrumb">
        <div class=container>
            <div class="flw bread">
                <h3 class=page-title>Avoid Going Broke By Month-End</h3>
            </div>
        </div>
    ...
    <div class=container>
        <div class=row>
			...
			<div class="case-detail-right flw">
				<div class="case-detail-info">
					<h3 class="case-detail-info-name">Avoid going broke by month end</h3>
					
				</div>
				<p class="case-detail-content">
					Remember, back in high school, when we were always lectured about how to save our money in class? But we actually never really learned how to <br><br>
					We could be care less about saving money or budgeting. However, these things come back to bite you in the life when you’re older because you have no money saved up<br><br>
		...
		<div class="project-tabs flw">
			<div id="tabs1" class="project-tabs-content display-none">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						<p>How often do you realize by the end of the month that you couldn't save the money that you planned to save?.  <br><br>
			...
			<div id="tabs2" class="project-tabs-content display-none">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						<h4>1. Look for Coupons and Discount</h4> <br><br>

						<p>Coupons and Discount allows you to save a lot of your money. Again be careful about the spending, you need need spend only the money that was reserved to spend and it doesn't exceed you brdget which will again lead you to over spendings.</p><br><br>
						<h4>2. Set Goals</h4>
						 <br>
