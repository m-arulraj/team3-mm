...
#platformRating select, #platformRating p {
	display: inline;
	vertical-align: top;
	line-height: 28px;
}
...
<body translate="no" bgcolor="#273746" onload="myFunction(${year})">
	<div class="header">
	...
	<div id="platformRating" style="color: white">
		<!-- <p style="padding-top: 10px">This is record of Year</p> -->

		<select id="year" class="simple">
		...
		<button onclick="callFunction()" type="submit" class="simpleButton">Submit</button>
	</div>

	<canvas id="myChart" style="height: 300px; width: 50%;"></canvas>
	<script
...
var myChart = new Chart(ctx, {
  ...
  options: {
    ...
    function callFunction(){
    	...
    	window.location.href = '/income-vs-investment-vs-expenses-report?year='+year;
    	console.log(year);
    }
