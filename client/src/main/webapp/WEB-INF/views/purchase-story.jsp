...
<main class="flw page_content service-detail" id=main>
    <nav class="flw breadcrumb">
        <div class=container>
            <div class="flw bread">
                <h3 class=page-title>KEEP TRACK OF THE PURCHASES</h3>
            </div>
        </div>
        ...
        <div class=row>
			...
			<div class="case-detail-right flw">
				<div class="case-detail-info">
					<h3 class="case-detail-info-name">Keep track of the Purchase</h3>
				
				</div>
				<p class="case-detail-content">
					Do you know where your money is going every month? If not, then that’s a huge mistake that you are doing. Start to track your expenses Today, and Figure out on what purchases you spend on.. <br><br>
					No Matter how much money you make, budgeting is the only way to keep control on your financial pattern. Often, people who are making a decent salary cannot get out of the vicious cycle of living paycheck to paycheck — and the reason why is because they are not tracking where all their money is going. Spend all there earnings purchase unnecessary things.<br><br>
		...
		<div class="project-tabs flw">
			<div id="tabs1" class="project-tabs-content display-none">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						<!-- <h3>THE Problem</h3> -->
						<p>How often do you realize by the end of the month that you made a wrong purchases and couldn't save the money that you planned to save?.  <br><br>

						Every great financial plan starts with a word budget. If you’re trying to pay off your bills and start saving mponey for a dream vacation, a budget is your first step toward making your dreams into a reality..</p>
					</div>
				</div>
			...
			<div id="tabs2" class="project-tabs-content display-none">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						...
						<p>Your first step towards saving money is finding out exactly how much you’re spending each month. You can do this by glancing your bank statements and bills. Add up everything you spent for the last six to 12 months and then divide by the amount of months, which will give you your average monthly expenses..</p><br><br>
						<h4>2. Set Goals</h4>
						 <br>
							<p> Figure out what your priorities are for both the Short and long-term plans. For example, buying a house, buying a car, a big vacation, emergency savings, retirement etc fall under long-term plans. Pay the bills and loans are the short term plans. <br><br>

						</p>
						<h4>3. Find the amount you Earn and the Amount you spend.</h4><br>
							<p>Now you have calculated how you are spending on everything, it’s time to figure out how much is coming in and where it’s all going each month. This will help you identify expenses that need to be tracked often.
						</p><br><br>
						<h4>4. Plan a Budget</h4><br>
							<p>Now you will have a clear picture of the total money coming in and the money going out, you can start tracking your expenses and then create your budget based on what you should be spending on most.<br><br>
						...
						<h4>4. Use App</h4><br>
							<p>ou can find thousand of apps that make your work easier. Best among that is <a href=" https://play.google.com/store/apps/details?id=com.splice&hl=en" target="_blank">Expensebit</a>, which has all the feature required for spliting expenses and track all your Purchase History.This app lets roommates track bills, tally who paid, and send reminders so you’re never late.
						</p>
					</div>
				</div>
				<div class="col-md-7 col-lg-7">
			...
			<div id="tabs3" class="project-tabs-content display-block">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						<!-- <h3>THE GOAL</h3> -->
						<h4>*  Use <a href="/">MoneyManager</a>, and it guides you have a Proper control over your money<br><br>
							*  You can be focus on your goals<br><br>
							*  You can be aware of your money in/out flow.<br><br>
							*  You can organise your spending and saving.<br><br>
							*  You can decide in advance what to do with your money.<br><br>
							*  You can even save the expected and unexpected costs.<br><br>
							*  Pre-Warned about the potential problems that arises.<br><br>
							*  It can enable you to generate extra money.<br><br>
						</h4>
					</div>
				</div>
				<div class="col-md-7 col-lg-7">
