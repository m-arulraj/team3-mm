...
<!-- HEADER -->
		...
		<!-- //HEADER -->
<!-- Main view  -->
<main id="main" class="page_content service-detail flw">
<!-- ABOUT NAV -->
<nav class="breadcrumb flw">
	<div class="container">
		<div class="bread flw">
			<h3 class="page-title">Avoid Overspending</h3>
...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-lg-6">
			<div class="case-detail-thumbnail flw">
		...
		<div class="col-md-6 col-lg-6">
			<div class="case-detail-right flw">
				<div class="case-detail-info">
					<h3 class="case-detail-info-name">Avoid Overspending</h3>
			
				</div>
				<p class="case-detail-content">
					Are you a Long-Trem overspender?<br><br> If you start each month with great intentions and spend according to a fixed budget, but eventually you start making irrelevant purchases justified by that ever dangerous “this little things won’t hurt” attitude, you’re likely facing an empty bank account by the end of the month.
		...
		<div class="project-tabs flw">
			<div id="tabs1" class="project-tabs-content display-none">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						<h4>Problems of Over Spending</h4><br><br>
						<h5>
							<ol><li>Your Budget never adds up</li>
								<li>Your debts exceeds then your income</li>
								<li>Your fun spending exceeds more then your fixed expenses</li>
								<li>Your expenses rise more then your income</li>
								<li>you start investing on unwanted things instead of saving it for the future</li>
							</ol>
			...
			<div id="tabs2" class="project-tabs-content display-none">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						...
						<p>Your first step towards saving money and Avoiding Overspending is finding out exactly how much you’re spending each month. You can do this by glancing your bank statements and bills. Add up everything you spent for the last six to 12 months and then divide by the amount of months, which will give you your average monthly expenses..</p><br><br>
						<h4>2. Set Goals</h4>
						 <br>
							<p> Figure out what your priorities are for both the Short and long-term plans. For example, buying a house, buying a car, a big vacation, emergency savings, retirement etc fall under long-term plans. Pay the bills and loans are the short term plans. So that you will be having proper plan where to spend and limit yourself to avoid overspending. <br><br>

						</p>
						<h4>3. Find the amount you Earn and the Amount you spend.</h4><br>
							<p>Now you have calculated how you are spending on everything, it’s time to figure out how much is coming in and where it’s all going each month. This will help you identify expenses that need to be tracked often and on what you are overspending.
						</p><br><br>
			...
			<div id="tabs3" class="project-tabs-content display-block">
				<div class="col-md-5 col-lg-5">
					<div class="case-detail-content-left">
						<h4>*  Proper budgeting gives you control over your money<br><br>
