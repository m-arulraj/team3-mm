...
<h2 style="color: blue">Add an Expense :</h2>
	<div style="text-align:center">  <button id="myBtn" class="button">Add Type</button></div>
 	...
 	<div id="form-box">
		<form:form modelAttribute="transaction" action="/user-transaction/expense" method="get" onsubmit="myFunction()">
  <div>
    <span>Type:</span> 
  ...
  <div>
    <span>Date:</span> <form:input type="date" path="date" name="date" id=""/>
