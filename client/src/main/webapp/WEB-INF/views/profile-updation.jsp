		...
		<div class="container">
			...
			<div class="agile_info">
				...
				<div class="w3_info">
					...
					<p>Enter your details to update.</p>
					<h5 style="color: red">${error}</h5>
					<form:form action="/profile-updation" method="post"
						...
						<form:input path="gender" type="hidden"
								/>
					<form:input path="id" type="hidden"
						...
						<button class="btn btn-danger btn-block" type="submit">Update Profile</button>
					</form:form>
