...
public class SearchManagementResource {
	...
	public ResponseEntity<?> searchCategoryListByCategory(@PathVariable("name") String name,
	...
	public ResponseEntity<?> searchCategoryListByAmount(@PathVariable("name") String name,
			@PathVariable("id") Long id) {
	...
	@GetMapping(value = "user/{id}/type/{name}/dates")
	public ResponseEntity<?> searchCategoryListBydateWithBoundries(@PathVariable("name") String name,
			@PathVariable("id") Long id, @RequestParam("startDate") String startDate,
	...
	public ResponseEntity<?> searchCategoryListByAmountWithRange(@PathVariable("name") String name,
			@PathVariable("id") Long id, @PathVariable("amount") Long amount) {
